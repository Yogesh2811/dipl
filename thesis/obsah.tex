...
\textbf{ZRTP} is a protocol that extends RTP for secure establishing session key using 
...
The main advantage is that it doesn't require any prior shared secret nor public
key infrastructure.
