...
The mediator object communicates with multiple colleague object through shared
interface.
...
\item \textbf{Daemon thread} -- the implementation of the entire stack is based 
on the daemon design pattern.
\item textbf{Packet Processing Thread} --
\end{itemize} 
...
\begin{itemize}
\item Network Layer
\item Packet Processing Layer
\item Payload Encoding
\end{itemize}
