...
aproach is based on abstracting the units of work from the programmers code into
virtual threads -- work-items. The convinience it offers in allocation
...
\end{tabular}
\end{center}
\caption{Selected comparison of AES implementation.}
