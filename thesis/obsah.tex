...
\item 50 to 150 concurrent calls in the same time
...
\subsection*{AES}
For the comparison of effectivity of the AES implementation, in figure 
\ref{aes-comparison} are given time requirements for execution of multiple
blocks encrypted by 128-bit AES.
\begin{table}[H]
\begin{center}
\begin{tabular}{|l|ccccc|}\hline%
  Implementation   & 1 block & 5 block & 10 block & 15 block & 20 block\\\hline
  Serial                 & 5       & 5       & 5        & 5        & 5 \\
  Persistent thread      & 5       & 5       & 5        & 5        & 5 \\
  Massive Parallel       & 5       & 5       & 5        & 5        & 5 \\
  m5t\cite{m5t}          & 5       & 5       & 5        & 5        & 5 \\      
  comparison01\cite{aes-cmp1}& 5   & 5       & 5        & 5        & 5 \\
 \hline
\end{tabular}
\end{center}
\caption{Selected comparison of AES implementation.} %\cite{rtpbandwidth}
\label{bandwidth}
\end{table}
