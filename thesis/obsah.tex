...
stands on three -- mediator pattern, singleton pattern\cite{design-patterns} 
and protocol stack pattern \cite{protocol-stack}. None of
...
via two sockets, for RTP and RTCP. This thread includes storage of the packets 
and another processed data.
...
Multiple Data} programming paradigms \cite{Flynn:1972}. The 
...
Number of concurrent calls \cite{hp4k}.
