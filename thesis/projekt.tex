...
\projectinfo{
  ...
  acknowledgment={Na tomto místì bych rád vìnoval pár slov svému vedoucímu Ing.
  Peteru Jurneèkovi za èas, který mi byl ochotný vìnovat, ochotu a pomoc
  pøi øe¹ení problémù a motivaci pro dokonèení práce.
  Ronì¾ bych rád podìkoval spoleènosti Siemens Enterprise Communications
  za poskytnutí prostorù a prostøedkù pro testování implementace, je¾ byla
  souèástí této diplomové práce.
  } % nepovinne
}
