...
\lstdefinestyle{FormattedNumber}{%
    literate={0}{\textcolor{brown}{0}}{1}%
             ...
             {.0}{\textcolor{brown}{.0}}{1}% Following is to ensure that only periods
             {.1}{\textcolor{brown}{.1}}{1}% followed by a digit are changed.
             {.2}{\textcolor{brown}{.2}}{1}%
             {.3}{\textcolor{brown}{.3}}{1}%
             {.4}{\textcolor{brown}{.4}}{1}%
             {.5}{\textcolor{brown}{.5}}{1}%
             ...
             {.8}{\textcolor{brown}{.8}}{1}%
             {.9}{\textcolor{brown}{.9}}{1}%
             {,}{\textcolor{brown},}{1}% depends if you want the "," in color
             {\ }{ }{1}% handle the space
             ,
